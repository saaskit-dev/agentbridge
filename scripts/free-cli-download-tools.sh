#!/bin/sh
# free-cli-download-tools.sh - fetch difftastic and ripgrep binaries
# usage: ./scripts/free-cli-download-tools.sh [platform ...]
#        ./scripts/free-cli-download-tools.sh all
...
archives="$CLI_DIR/tools/archives"

 ...
 * Implements the full AsyncIterableIterator protocol including return() and throw().
 *
 */
...
export class PushableAsyncIterable<T> implements AsyncIterableIterator<T> {
   ...
   * All subsequent iterations will throw this error
   */
   ...
   * Called when consumer breaks out of loop
   */
  ...
  /**
   * Make this iterable
   * Note: Can only be iterated once
   */

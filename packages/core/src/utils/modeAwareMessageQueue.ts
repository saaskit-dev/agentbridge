/**
 * Mode-aware message queue for batching messages with the same mode
 *
 * A message queue that stores messages with their modes and returns
 * consistent batches of messages with the same mode.
 *
 */
 ...
 */
export class ModeAwareMessageQueue<T> {

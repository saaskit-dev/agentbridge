...
class ProfileSyncService {
    ...
    public async syncGuiToCli(profiles: AIBackendProfile[]): Promise<void> {
        ...
        try {
            ...
            console.log(`[ProfileSync] GUI profiles stored in Free settings. CLI access via existing infrastructure.`);
    ...
    public async getActiveProfile(): Promise<AIBackendProfile | null> {
        try {
            ...
            if (activeProfile) {
                console.log(`[ProfileSync] Retrieved active profile ${activeProfile.name} from Free settings`);

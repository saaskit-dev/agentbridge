...
export function machinesRoutes(app: Fastify) {
        ...
        if (machine) {
            ...
            return reply.send({
                machine: {
                    ...
                    dataEncryptionKey: machine.dataEncryptionKey, // Already base64 string
            ...
            const newMachine = await db.machine.create({
                data: {
                    ...
                    active: false, // Daemon will set to true when it connects
                }
            });
            ...
            return reply.send({
                machine: {
                    ...
                    dataEncryptionKey: newMachine.dataEncryptionKey, // Already base64 string
    ...
    app.get('/v1/machines', {
        ...
        return machines.map(m => ({
            ...
            dataEncryptionKey: m.dataEncryptionKey, // Already base64 string
            seq: m.seq,
            active: m.active,

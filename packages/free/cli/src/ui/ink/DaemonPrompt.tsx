...
export const DaemonPrompt: React.FC<DaemonPromptProps> = ({ onSelect }) => {
    ...
    return (
        <Box flexDirection="column">
            <Box marginBottom={1}>
                <Text bold color="cyan">🚀 Free Daemon Setup</Text>
            </Box>
            
            <Box flexDirection="column" marginBottom={1}>
                <Text>📱 Free can run a background service that allows you to:</Text>
            ...
            <Box marginBottom={1}>
                <Text>Would you like Free to start this service automatically?</Text>
            </Box>

/**
 * Installation script for Free daemon using macOS LaunchDaemons
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the free command. 
 * 
 ...
 * 2. We assume users will run free frequently (every time they open their laptop)
...
export async function install(): Promise<void> {
    try {
        ...
        // Get the path to the free CLI executable
        const freePath = process.argv[0]; // Node.js executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <array>
                    ...
                    <string>free-daemon</string>
                </array>
                
                <key>EnvironmentVariables</key>
                <dict>
                    <key>FREE_DAEMON_MODE</key>
                    <string>true</string>
                </dict>
                ...
                <string>${os.homedir()}/.free/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.free/daemon.log</string>
        ...
        logger.info('Check logs at ~/.free/daemon.log');

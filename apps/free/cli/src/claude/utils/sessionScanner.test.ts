...
describe('sessionScanner', () => {
  ...
  it('should process initial session and resumed session correctly', async () => {
    ...
    const fixture1 = await readFile(
      join(__dirname, '__fixtures__', '0-say-lol-session.jsonl'),
      'utf-8'
    );
    ...
    const fixture2 = await readFile(
      join(__dirname, '__fixtures__', '1-continue-run-ls-tool.jsonl'),
      'utf-8'
    );

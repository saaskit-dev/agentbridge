...
describe('parseTmuxSessionIdentifier', () => {
  ...
  it('should throw on empty string', () => {
    ...
    expect(() => parseTmuxSessionIdentifier('')).toThrow(
  ...
  it('should throw on invalid session name characters', () => {
    ...
    expect(() => parseTmuxSessionIdentifier('invalid session')).toThrow(
  ...
  it('should throw on invalid window name characters', () => {
    expect(() => parseTmuxSessionIdentifier('session:invalid window')).toThrow(
      TmuxSessionIdentifierError
    );
    expect(() => parseTmuxSessionIdentifier('session:invalid window')).toThrow(
      'Only alphanumeric characters, dots, hyphens, and underscores are allowed'
  ...
  it('should throw on non-numeric pane identifier', () => {
    expect(() => parseTmuxSessionIdentifier('session:window.abc')).toThrow(
      TmuxSessionIdentifierError
    );
    expect(() => parseTmuxSessionIdentifier('session:window.abc')).toThrow(
  ...
  it('should throw on pane identifier with special characters', () => {
    expect(() => parseTmuxSessionIdentifier('session:window.1a')).toThrow(
      TmuxSessionIdentifierError
    );
    expect(() => parseTmuxSessionIdentifier('session:window.-1')).toThrow(
      TmuxSessionIdentifierError
    );
  });
...
describe('formatTmuxSessionIdentifier', () => {
  ...
  it('should throw when session is missing', () => {
    ...
    expect(() => formatTmuxSessionIdentifier(identifier)).toThrow(

...
describe('deterministicStringify', () => {
  ...
  it('should handle undefined values according to options', () => {
    ...
    // null behavior
    expect(deterministicStringify(obj, { undefinedBehavior: 'null' })).toBe(
      '{"a":1,"b":null,"c":3}'
    );

    // throw behavior
    expect(() => deterministicStringify(obj, { undefinedBehavior: 'throw' })).toThrow(
      'Undefined value at key: b'
    );
  });

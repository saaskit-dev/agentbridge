...
class Configuration {
  ...
  constructor() {
    ...
    this.isExperimentalEnabled = ['true', '1', 'yes'].includes(process.env.FREE_EXPERIMENTAL?.toLowerCase() || '');
    this.disableCaffeinate = ['true', '1', 'yes'].includes(process.env.FREE_DISABLE_CAFFEINATE?.toLowerCase() || '');

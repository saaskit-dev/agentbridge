/**
 * mapOpenCodeRawToNormalized — maps AgentMessage (ACP) to NormalizedMessage.
 *
...
export function mapOpenCodeRawToNormalized(msg: AgentMessage): NormalizedMessage | null {
  const id = createId();

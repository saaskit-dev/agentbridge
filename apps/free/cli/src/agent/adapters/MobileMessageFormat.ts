 ...
 *
 * This module defines the message format expected by the Free mobile app.
 * Messages from any agent (Gemini, Codex, Claude, etc.) are transformed
 * to this format before being sent through the Free server.
 *
 ...
 */
export type MobileAgentType = 'gemini' | 'codex' | 'claude' | 'claude-native' | 'opencode';

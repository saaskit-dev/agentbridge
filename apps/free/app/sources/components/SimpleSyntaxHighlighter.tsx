...
const tokenizeCode = (code: string, language: string | null) => {
  ...
  const patterns = [
    ...
    {
      regex: /\b(function|def|async function)\s+([a-zA-Z_$][a-zA-Z0-9_$]*)/g,
      type: 'function',
      captureGroup: 2,
    },
  ...
  lines.forEach((line, lineIndex) => {
    ...
    patterns.forEach(pattern => {
      ...
      while ((match = pattern.regex.exec(line)) !== null) {
        ...
        const tokenStart = pattern.captureGroup
    ...
    switch (type) {
      ...
      case 'bracket':
        switch ((nestLevel || 1) % 5) {
          case 1:
            return colors.bracket1;
          case 2:
            return colors.bracket2;
          case 3:
            return colors.bracket3;
          case 4:
            return colors.bracket4;
          case 0:
            return colors.bracket5; // Level 5, 10, 15, etc.
          default:
            return colors.bracket1;
        }
      default:

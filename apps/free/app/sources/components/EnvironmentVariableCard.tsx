...
export function EnvironmentVariableCard({
  ...
  const showRemoteDiffersWarning =
    remoteValue !== null && expectedValue && remoteValue !== expectedValue;
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: theme.margins.md }}>
          <Pressable hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }} onPress={onDelete}>
            <Ionicons
              name="trash-outline"
          ...
          <Pressable hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }} onPress={onDuplicate}>
            <Ionicons
              name="copy-outline"
              size={theme.iconSize.large}
      ...
      >
        <View
          style={{
            ...
            borderWidth: 2,
            borderColor: useRemoteVariable
              ? theme.colors.button.primary.background
              : theme.colors.textSecondary,
            backgroundColor: useRemoteVariable
              ? theme.colors.button.primary.background
              : 'transparent',

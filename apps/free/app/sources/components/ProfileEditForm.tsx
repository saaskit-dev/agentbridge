      ...
      <View style={profileEditFormStyles.formContainer}>
        ...
        >
          {useTmux
            ...
            : 'Sessions spawn in regular shell (no tmux integration)'}
        </Text>
        ...
        >
          Leave empty to use first existing tmux session (or create "free" if none exist). Specify
          name (e.g., "my-work") for specific session.
        </Text>
        <TextInput
          style={{
            backgroundColor: theme.colors.input.background,

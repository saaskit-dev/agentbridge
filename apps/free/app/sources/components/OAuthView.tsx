...
export const OAuthView = React.memo(
  (props: {
    name: string;
    command?: string;
    backgroundColor?: string;
...
export const OAuthViewRender = React.memo(
  (props: {
    name: string;
    config: OAuthViewConfig;
      ...
      return (
        <View style={[styles.errorContainer]}>
          ...
          <TouchableOpacity style={styles.retryButton} onPress={props.onRetry}>
            <Text style={[styles.retryButtonText, { color: props.foregroundColor }]}>
              {t('common.retry')}
            </Text>
          </TouchableOpacity>
        </View>
      ...
      <>
        ...
        {webViewLoading && (
          <Animated.View
            style={[
              ...
              webViewLoadingAnimatedStyle,
              { backgroundColor: props.backgroundColor },
            ]}
          >
            <ActivityIndicator size="large" color={props.foregroundColor || theme.colors.text} />
            <Text style={[styles.loadingText, { color: props.foregroundColor }]}>
              {t('common.loading')}
            </Text>
          </Animated.View>
        )}
        {exchangingTokens && (
          <Animated.View
            style={[
              styles.loadingOverlay,
              tokenExchangeAnimatedStyle,
              { backgroundColor: props.backgroundColor },
            ]}
          >
            <ActivityIndicator size="large" color={props.foregroundColor || theme.colors.text} />
            <Text style={[styles.loadingText, { color: props.foregroundColor }]}>
              {t('settings.exchangingTokens')}
            </Text>
          </Animated.View>
        )}
      </>
...
export const OAuthViewUnsupported = React.memo((props: { name: string; command?: string }) => {
  const command = props.command || `free connect ${props.name.toLowerCase()}`;

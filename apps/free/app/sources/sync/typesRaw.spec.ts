        ...
        content: {
          ...
          data: {
            ...
            message: {
              role: 'assistant',
              model: 'claude-3',
              content: [{ type: 'tool_use', id: 'call_old', name: 'Read', input: {} }],
            },
            uuid: 'old-uuid',
          },
        },
  ...
  describe('Unexpected data format robustness', () => {
    ...
    it('handles summary messages', () => {
      ...
      if (
        result.success &&
        result.data.content.type === 'output' &&
        result.data.content.data.type === 'summary'
      ) {
        ...
        content: {
          ...
          data: {
            ...
            message: {
              role: 'assistant',
              model: 'claude-3',
              content: [{ type: 'tool_use', id: 'claude_1', name: 'Bash', input: {} }],
            },
            uuid: 'claude-uuid',
          },
        },
        ...
        content: {
          ...
          data: {
            ...
            message: {
              role: 'assistant',
              model: 'claude-3',
              content: [{ type: 'tool-call', callId: 'idem_1', name: 'Bash', input: {} }],
            },
            uuid: 'idem-uuid',
          },
        },

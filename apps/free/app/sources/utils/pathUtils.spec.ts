...
describe('pathUtils', () => {
    ...
    describe('integration scenarios', () => {
        it('should work with typical macOS home directories', () => {
            ...
            expect(resolveAbsolutePath('~/Projects/free', homeDir)).toBe('/Users/developer/Projects/free');
        ...
        it('should work with typical Windows home directories', () => {
            ...
            expect(resolveAbsolutePath('~/Projects/free', homeDir)).toBe('C:\\Users\\developer\\Projects/free');

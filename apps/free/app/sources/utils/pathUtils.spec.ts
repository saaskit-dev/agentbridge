...
describe('pathUtils', () => {
  describe('resolveAbsolutePath', () => {
    describe('basic tilde expansion', () => {
      ...
      it('should expand ~/Documents/project to nested path', () => {
        expect(resolveAbsolutePath('~/Documents/project', '/Users/user')).toBe(
          '/Users/user/Documents/project'
        );
      });

      it('should expand ~/Documents/deep/nested/path', () => {
        expect(resolveAbsolutePath('~/Documents/deep/nested/path', '/Users/user')).toBe(
          '/Users/user/Documents/deep/nested/path'
        );
      });
    });
    ...
    describe('non-tilde paths remain unchanged', () => {
      ...
      it('should not modify absolute Windows paths', () => {
        expect(resolveAbsolutePath('C:\\Program Files', 'C:\\Users\\steve')).toBe(
          'C:\\Program Files'
        );
      });
    ...
    describe('Windows path handling', () => {
      ...
      it('should use Windows separator for Windows home', () => {
        expect(resolveAbsolutePath('~/Documents', 'C:\\Users\\steve')).toBe(
          'C:\\Users\\steve\\Documents'
        );
        expect(resolveAbsolutePath('~/Documents/project', 'C:\\Users\\steve')).toBe(
          'C:\\Users\\steve\\Documents/project'
        );
      });
    ...
    describe('edge cases', () => {
      ...
      it('should handle paths with spaces', () => {
        expect(resolveAbsolutePath('~/My Documents', '/Users/user')).toBe(
          '/Users/user/My Documents'
        );
        expect(resolveAbsolutePath('~/Program Files/My App', 'C:\\Users\\steve')).toBe(
          'C:\\Users\\steve\\Program Files/My App'
        );
      });

      it('should handle paths with special characters', () => {
        expect(resolveAbsolutePath('~/Documents & Files', '/Users/user')).toBe(
          '/Users/user/Documents & Files'
        );
        expect(resolveAbsolutePath('~/folder@example.com', '/Users/user')).toBe(
          '/Users/user/folder@example.com'
        );
      });
    });
    ...
    describe('path separator normalization', () => {
      it('should use Unix separator for Unix home paths', () => {
        expect(resolveAbsolutePath('~/Documents/subfolder', '/home/user')).toBe(
          '/home/user/Documents/subfolder'
        );
        expect(resolveAbsolutePath('~/Documents/subfolder', '/Users/user')).toBe(
          '/Users/user/Documents/subfolder'
        );
      });

      it('should use Windows separator for Windows home paths', () => {
        expect(resolveAbsolutePath('~/Documents/subfolder', 'C:\\Users\\steve')).toBe(
          'C:\\Users\\steve\\Documents/subfolder'
        );
      });
  ...
  describe('resolvePath (existing function)', () => {
    ...
    it('should not resolve sibling directory paths that start with metadata path', () => {
      ...
      expect(resolvePath('/Users/dev/other-project/sources/types/index.ts', metadata)).toBe(
        '/Users/dev/other-project/sources/types/index.ts'
      );
    });
    ...
    it('should handle edge case where metadata path is a substring of another path', () => {
      ...
      expect(resolvePath('/home/user/app-v2/src/main.js', metadata)).toBe(
        '/home/user/app-v2/src/main.js'
      );
      expect(resolvePath('/home/user/application/config.json', metadata)).toBe(
        '/home/user/application/config.json'
      );
    });
  });
  ...
  describe('integration scenarios', () => {
    it('should work with typical macOS home directories', () => {
      ...
      expect(resolveAbsolutePath('~/Projects/free', homeDir)).toBe(
        '/Users/developer/Projects/free'
      );
      expect(resolveAbsolutePath('~/Desktop/file.txt', homeDir)).toBe(
        '/Users/developer/Desktop/file.txt'
      );
    });
    ...
    it('should work with typical Linux home directories', () => {
      ...
      expect(resolveAbsolutePath('~/projects/free', homeDir)).toBe('/home/developer/projects/free');
      expect(resolveAbsolutePath('~/documents/file.txt', homeDir)).toBe(
        '/home/developer/documents/file.txt'
      );
    });
    ...
    it('should work with typical Windows home directories', () => {
      ...
      expect(resolveAbsolutePath('~/Projects/free', homeDir)).toBe(
        'C:\\Users\\developer\\Projects/free'
      );
      expect(resolveAbsolutePath('~/Desktop/file.txt', homeDir)).toBe(
        'C:\\Users\\developer\\Desktop/file.txt'
      );
    });
    ...
    it('should handle common session creation scenarios', () => {
      ...
      expect(resolveAbsolutePath('~/Documents/Projects', macHomeDir)).toBe(

...
describe('compareToolCalls', () => {
  ...
  it('should handle null and undefined arguments', () => {
    expect(
      compareToolCalls({ name: 'Test', arguments: null }, { name: 'Test', arguments: null })
    ).toBe(true);
    ...
    expect(
      compareToolCalls({ name: 'Test', arguments: null }, { name: 'Test', arguments: undefined })
    ).toBe(false);
  });
  ...
  it('should handle empty objects and arrays', () => {
    expect(compareToolCalls({ name: 'Test', arguments: {} }, { name: 'Test', arguments: {} })).toBe(
      true
    );

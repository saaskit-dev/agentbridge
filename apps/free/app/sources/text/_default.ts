/**
 * English translations for the Free app
 * Values can be:
...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Free is a multi-agent mobile client supporting Claude Code, Codex, Gemini and more. Fully end-to-end encrypted with accounts stored only on your device.',
        whatsNew: 'What\'s New',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Free Coder account. This will allow the terminal to send and receive messages securely.',

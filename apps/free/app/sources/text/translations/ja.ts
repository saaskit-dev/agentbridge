...
export const ja: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'Free CoderはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
    ...
    newSession: {
        ...
        title: '新しいセッションを開始',
        noMachinesFound: 'マシンが見つかりません。まずコンピューターでFreeセッションを起動してください。',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがFree Coderアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',

...
export const pl: TranslationStructure = {
  ...
  sessionInfo: {
    ...
    viewUsage: 'Zobacz użycie',
    viewUsageSubtitle: 'Zobacz podział tokenów i kosztów dla tej sesji',
  ...
  usage: {
    ...
    filteringBy: ({ dimension, value }: { dimension: string; value: string }) =>
      `Filtrowanie według ${dimension}: ${value}`,
    sessionOnly: 'Wyświetlanie tylko tej sesji',
  },

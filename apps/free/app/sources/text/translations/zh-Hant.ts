...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        about: '關於',
        aboutFooter: 'Free 是一個多智能體行動用戶端，支援 Claude Code、Codex、Gemini 等 AI Agent。採用端對端加密，帳戶僅儲存在本機裝置。',
        whatsNew: '更新日誌',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有終端正在請求連線到您的 Free Coder 帳戶。這將允許終端安全地傳送和接收訊息。',

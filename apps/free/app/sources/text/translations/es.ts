...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Free Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    newSession: {
        ...
        noMachinesFound: 'No se encontraron máquinas. Inicia una sesión de Free en tu computadora primero.',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g @free/cli@latest',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Free Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',

...
export const es: TranslationStructure = {
  ...
  server: {
    ...
    devIgnoringProductionServer:
      'El modo de desarrollo está ignorando la URL del servidor de producción y usando el servidor local de desarrollo.',
  ...
  sessionInfo: {
    ...
    viewUsage: 'Ver uso',
    viewUsageSubtitle: 'Ver el desglose de tokens y costo de esta sesión',
  ...
  agentInput: {
    ...
    speechInput: {
      ...
      permissionBrowserMessage:
        'Permite el acceso al micrófono y al reconocimiento de voz en la configuración del sitio del navegador.',
      ...
      unsupportedTitle: 'La entrada por voz no está disponible',
      unsupportedMessage:
        'Este navegador aún no admite la entrada por voz. Usa un navegador compatible o escribe tu mensaje.',
  ...
  files: {
    ...
    download: 'Descargar',
    downloadFolder: 'Descargar como ZIP',
    delete: 'Eliminar',
    ...
    fileTooLargeToDownload: 'El archivo es demasiado grande para descargar (máx. 10 MB)',
    downloadFolderError: 'Error al descargar la carpeta',
  ...
  usage: {
    ...
    breakdown: 'Desglose',
    agent: 'Agente',
    modelDimension: 'Modelo',
    source: 'Origen',
    clearFilter: 'Limpiar',
    filteringBy: ({ dimension, value }: { dimension: string; value: string }) =>
      `Filtrando por ${dimension}: ${value}`,
    sessionOnly: 'Viendo solo esta sesión',
  },

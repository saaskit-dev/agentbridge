...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Free Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    newSession: {
        ...
        noMachinesFound: 'Nenhuma máquina encontrada. Inicie uma sessão Free no seu computador primeiro.',
    ...
    sessionInfo: {
        ...
        updateCliInstructions: 'Por favor execute npm install -g @free/cli@latest',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Free Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',

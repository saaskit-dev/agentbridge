...
export const zhHans: TranslationStructure = {
    ...
    settings: {
        ...
        about: '关于',
        aboutFooter: 'Free 是一个多智能体移动客户端，支持 Claude Code、Codex、Gemini 等 AI Agent。采用端到端加密，账户仅存储在本地设备。',
        whatsNew: '更新日志',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有终端正在请求连接到您的 Free Coder 账户。这将允许终端安全地发送和接收消息。',

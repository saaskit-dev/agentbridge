...
export const zhHans: TranslationStructure = {
  ...
  focusAudio: {
    ...
    disabledState: '已关闭',
    sound: '声音',
    soundFooter: '选择你希望在专注音频开启时听到的环境音。',
    ...
    homeBackgroundPlaybackCompactEnabled: '后台播放',
  },
  ...
  settingsFeatures: {
    ...
    markdownCopyV2Subtitle: '使用内联文本选择复制 Markdown',
  ...
  server: {
    ...
    devIgnoringProductionServer: '开发模式已忽略生产服务器地址，当前改用本地开发服务器。',
  ...
  settingsAccount: {
    ...
    notAvailable: '不可用',
    linkNewDevice: '链接新设备',
    linkNewDeviceSubtitle: '扫描二维码或手动输入链接来连接设备',
    profile: '个人资料',
    name: '姓名',
    github: 'GitHub',

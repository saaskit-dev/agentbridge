...
export default function FeaturesSettingsScreen() {
  ...
  const [useEnhancedSessionWizard, setUseEnhancedSessionWizard] = useSettingMutable(
    ...
    <ItemList style={{ paddingTop: 0 }}>
      ...
      >
        ...
        <Item
          ...
          rightElement={
            <Switch value={useEnhancedSessionWizard} onValueChange={setUseEnhancedSessionWizard} />
          }
          showChevron={false}
        />
      </ItemGroup>
      ...
      {Platform.OS === 'web' && (
        ...
        >
          <Item
            ...
            rightElement={
              <Switch value={agentInputEnterToSend} onValueChange={setAgentInputEnterToSend} />
            }
            showChevron={false}
          />
          <Item
            ...
            rightElement={
              <Switch value={commandPaletteEnabled} onValueChange={setCommandPaletteEnabled} />
            }
            showChevron={false}
          />
        </ItemGroup>

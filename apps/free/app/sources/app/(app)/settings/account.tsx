...
export default React.memo(() => {
  ...
  const [disconnecting, handleDisconnectGitHub] = useFreeAction(async () => {
      ...
      <ItemList>
        ...
        {(displayName || githubUsername || profile.avatar) && (
          <ItemGroup title={t('settingsAccount.profile')}>
            {displayName && (
              <Item title={t('settingsAccount.name')} detail={displayName} showChevron={false} />
            )}
            {githubUsername && (
              <Item
        ...
        {profile.connectedServices &&
          profile.connectedServices.length > 0 &&
          (() => {
        ...
        >
          <Item
            ...
            subtitle={
              showSecret ? t('settingsAccount.tapToHide') : t('settingsAccount.tapToReveal')
            }
            icon={
              <Ionicons

    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          <Ionicons name="alert-circle-outline" size={64} style={styles.errorIcon} />
          <Text style={styles.errorText}>{error || t('artifacts.error')}</Text>
        </View>
      </View>
    );
  }
        ...
        options={{
          ...
          headerRight: () => (
            <View style={{ flexDirection: 'row' }}>
              ...
              <Pressable onPress={handleDelete} style={{ padding: 8 }} disabled={isDeleting}>
                <Ionicons
                  name="trash-outline"
                  size={22}
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.titleContainer}>
            <Text style={[styles.title, !artifact.title && styles.untitledTitle]}>

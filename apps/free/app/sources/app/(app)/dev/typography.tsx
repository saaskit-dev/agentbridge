    ...
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <TextSample title="Regular (400)" style={Typography.default()} />

          <TextSample title="Italic" style={Typography.default('italic')} />

          <TextSample title="Semi-Bold (600)" style={Typography.default('semiBold')} />
        </View>
        ...
        <View style={styles.section}>
          ...
          <CodeSample title="Regular (400)" style={Typography.mono()} />

          <CodeSample title="Italic" style={Typography.mono('italic')} />

          <CodeSample title="Semi-Bold (600)" style={Typography.mono('semiBold')} />
        </View>
        ...
        <View style={styles.section}>
          ...
          <ItemGroup title="List Item Typography">
            ...
            />
            <Item title="Monospace Detail" detail="v1.0.0" detailStyle={{ ...Typography.mono() }} />
          </ItemGroup>
        </View>

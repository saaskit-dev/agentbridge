  ...
  return (
    <ItemList>
      ...
      <ItemGroup title="Basic Items">
        ...
        />
        <Item title="Item with Detail" detail="Detail" />
        <Item title="Clickable Item" onPress={() => console.log('Item pressed')} />
      </ItemGroup>
      ...
      <ItemGroup
        title="Interactive"
        footer="These items demonstrate various interactive states and elements"
      >
        <Item
          title="Toggle Switch"
          rightElement={<Switch value={isEnabled} onValueChange={setIsEnabled} />}
          showChevron={false}
        />
        <Item
          title="Selected Item"
        ...
        />
        <Item title="Loading State" loading={true} onPress={() => {}} />
        <Item title="Disabled Item" disabled={true} onPress={() => {}} />
        <Item title="Destructive Action" destructive={true} onPress={() => {}} />
      </ItemGroup>
      ...
      <ItemGroup title="Custom Styling">
        <Item
          ...
          onPress={() => {}}
        />
        <Item title="No Divider" showDivider={false} />
        <Item title="Custom Inset" dividerInset={60} />
        <Item title="No Chevron" showChevron={false} onPress={() => {}} />
      </ItemGroup>

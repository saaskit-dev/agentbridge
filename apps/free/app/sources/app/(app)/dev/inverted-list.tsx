          ...
          <View>
            ...
            <View style={styles.buttonRow}>
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  listType === 'flash' ? styles.buttonActive : styles.buttonInactive,
                ]}
              >
                <Text
                  style={[
                    styles.buttonText,
                    listType === 'flash' ? styles.buttonTextActive : styles.buttonTextInactive,
                  ]}
                >
                  FlashList
                </Text>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  listType === 'flat' ? styles.buttonActive : styles.buttonInactive,
                ]}
              >
                <Text
                  style={[
                    styles.buttonText,
                    listType === 'flat' ? styles.buttonTextActive : styles.buttonTextInactive,
                  ]}
                >
                  FlatList
                </Text>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.button,
                  listType === 'legend' ? styles.buttonActive : styles.buttonInactive,
                ]}
              >
                <Text
                  style={[
                    styles.buttonText,
                    listType === 'legend' ? styles.buttonTextActive : styles.buttonTextInactive,
                  ]}
                >
                  LegendList
                </Text>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.buttonRow}>
                <TouchableOpacity
                  ...
                  style={[
                    styles.button,
                    paddingType === 'animated' ? styles.buttonActive : styles.buttonInactive,
                  ]}
                >
                  <Text
                    style={[
                      styles.buttonText,
                      paddingType === 'animated'
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.button,
                    paddingType === 'non-animated' ? styles.buttonActive : styles.buttonInactive,
                  ]}
                >
                  <Text
                    style={[
                      styles.buttonText,
                      paddingType === 'non-animated'
                        ? styles.buttonTextActive
                        : styles.buttonTextInactive,
                    ]}
                  >
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.button,
                    paddingType === 'header-footer' ? styles.buttonActive : styles.buttonInactive,
                  ]}
                >
                  <Text
                    style={[
                      styles.buttonText,
                      paddingType === 'header-footer'
                        ? styles.buttonTextActive
                        : styles.buttonTextInactive,
                    ]}
                  >
        ...
        {(() => {
          const ListEmptyComponent = (
            <View style={styles.emptyState}>
              <Text style={styles.emptyStateText}>No messages yet. Type something below!</Text>
            </View>
          );

          const ListHeaderComponent =
            paddingType === 'header-footer' ? <View style={{ height: paddingValue }} /> : undefined;

...
const ColorPair = ({ name, bg, text }: { name: string; bg: string; text: string }) => (
  <View style={styles.swatchContainer}>
    <View style={[styles.swatch, { backgroundColor: bg }]}>
      <Text style={{ color: text, ...Typography.default('semiBold'), marginBottom: 4 }}>
        {name}
      </Text>
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        {/* Gray Scale */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, Typography.default('semiBold')]}>Gray Scale</Text>
        ...
        {/* Backgrounds */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, Typography.default('semiBold')]}>Backgrounds</Text>
        ...
        {/* Usage in Code */}
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, Typography.default('semiBold')]}>Usage Examples</Text>

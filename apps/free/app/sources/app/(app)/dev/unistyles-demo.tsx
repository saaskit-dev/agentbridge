...
const logger = new Logger('app/dev/unistyles-demo');
...
export default function UnistylesDemo() {
  ...
  const toggleColorScheme = () => {
    ...
    logger.debug('Color scheme toggle requested - this would typically be system controlled');
  };
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.themeCard}>
            <Text style={styles.themeText}>Current Theme: {rt.themeName}</Text>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 8 }}>
            <Pressable style={styles.themeButton} onPress={() => switchTheme('light')}>
              <Text style={styles.themeButtonText}>Light</Text>
            </Pressable>
            <Pressable style={styles.themeButton} onPress={() => switchTheme('dark')}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.breakpointBox}>
            <Text style={styles.breakpointText}>Active Breakpoint: {rt.breakpoint}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.orientationBox}>
            <Ionicons
              ...
              color="white"
            />
            <Text style={styles.orientationText}>{rt.isPortrait ? 'Portrait' : 'Landscape'}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.switchContainer}>
            ...
            <Switch value={showRuntimeInfo} onValueChange={setShowRuntimeInfo} />
          </View>

          {showRuntimeInfo && (
            <>
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>Theme: {rt.themeName}</Text>
              </View>
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>Breakpoint: {rt.breakpoint}</Text>
              </View>
              <View style={styles.runtimeBox}>
              ...
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>Color Scheme: {rt.colorScheme}</Text>
              </View>
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>Content Size: {rt.contentSizeCategory}</Text>
              </View>
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>
              ...
              <View style={styles.runtimeBox}>
                <Text style={styles.runtimeText}>
                  Safe Insets: T:{rt.insets.top} B:{rt.insets.bottom} L:{rt.insets.left} R:
                  {rt.insets.right}
                </Text>
              </View>
            </>
          ...
          <Pressable style={[styles.themeButton, { marginTop: 12 }]} onPress={toggleColorScheme}>
            <Text style={styles.themeButtonText}>Toggle Color Scheme ({rt.colorScheme})</Text>
          </Pressable>
        </View>
        ...
        <View
          style={[
            styles.section,
            { backgroundColor: '#FFF3CD', borderColor: '#FFEAA7', borderWidth: 1 },
          ]}
        >
          <Text style={[styles.sectionTitle, { color: '#856404' }]}>⚡ Performance Note</Text>
          <Text style={{ color: '#856404', lineHeight: 20 }}>
            Unistyles compiles styles at build time and provides runtime optimizations. All the
            responsive features you see here work without performance penalties thanks to the native
            bridge integration.
          </Text>
        </View>
      </ScrollView>

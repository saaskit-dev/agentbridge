        ...
        <View style={{ backgroundColor: '#fcfcfc' }}>
          <View style={{ padding: 16 }}>
            ...
            >
              ...
              >
                <Text style={{ color: '#fff', fontSize: 14, fontWeight: '600' }}>Comment</Text>
              </Pressable>
            </View>
          </View>
          <View
    ...
    },
    {
      ...
      preview: (
        <View style={{ backgroundColor: '#f6f8fa' }}>
          ...
          >
            <Text style={{ fontSize: 12, color: '#6a737d' }}>Markdown is supported</Text>
        ...
        <View style={{ backgroundColor: '#2c2c2c' }}>
          <View style={{ padding: 16 }}>
            ...
            >
              ...
              >
                <Text style={{ color: '#fff', fontSize: 14, fontWeight: '600' }}>Post</Text>
              </Pressable>
            </View>
          </View>
          <View
            ...
            >
              ...
              >
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Text style={{ color: '#71767b', fontSize: 14, marginRight: 12 }}>0/280</Text>
                  <Pressable
                    style={{
                      paddingHorizontal: 16,
                      paddingVertical: 8,
                  ...
                  >
                    <Text style={{ color: '#fff', fontSize: 15, fontWeight: '600' }}>Post</Text>
                  </Pressable>
                </View>
              </View>
            </View>
        ...
        <View style={{ backgroundColor: '#202020' }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ color: '#e0e0e0', fontSize: 12, marginLeft: 4 }}>Markdown</Text>
            </Pressable>
          </View>
        </View>
      ),
      ...
      preview: (
        <View style={{ backgroundColor: '#000' }}>
          ...
          >
            ...
            >
              <Text style={{ color: '#000', fontSize: 14, fontWeight: '600' }}>Snap</Text>
            </Pressable>
            <Pressable
              style={{
                paddingHorizontal: 16,
            ...
            >
              <Text style={{ color: '#fff', fontSize: 14 }}>Stickers</Text>
            </Pressable>
            <Pressable
              style={{
                paddingHorizontal: 16,
            ...
            >
              <Text style={{ color: '#fff', fontSize: 14 }}>Games</Text>
            </Pressable>
          </View>
        </View>
      ),
        ...
        <View style={{ backgroundColor: '#f5f5f5' }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 13, color: '#605e5c', marginLeft: 6 }}>Meet now</Text>
            </Pressable>
            <Pressable
              style={{
                flexDirection: 'row',
            ...
            >
              ...
              <Text style={{ fontSize: 13, color: '#605e5c', marginLeft: 6 }}>Schedule</Text>
            </Pressable>
          </View>
        </View>
      ),

          ...
          <View style={styles.resultsSection}>
            {isSearching && searchResults.length === 0 ? (
              ...
              <View style={styles.noResultsContainer}>
                <Text style={styles.noResultsText}>{t('friends.noUserFound')}</Text>
                <Text style={styles.noResultsHint}>{t('friends.checkUsername')}</Text>
              </View>
            ) : (
              <View style={styles.helpContainer}>
                <Text style={styles.helpTitle}>{t('friends.howToFind')}</Text>
                <Text style={styles.helpText}>{t('friends.findInstructions')}</Text>
              </View>
            )}
          </View>
        </ItemGroup>
